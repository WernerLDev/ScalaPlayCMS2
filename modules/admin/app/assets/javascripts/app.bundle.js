...
/***/ (function(module, exports, __webpack_require__) {
	...
	const Actions = __webpack_require__(44);
	let store = redux_1.createStore(index_1.default);
	store.dispatch(Actions.addTab("testasdfasf", () => (React.createElement("p", null, "test"))));
	store.dispatch(Actions.addTab("Another tab", () => (React.createElement("p", null, "test"))));
	        ...
	        return (React.createElement("div", null,
	            ...
	            React.createElement(TreeView_1.default, { items: this.state.treeItems, selected: this.state.selected, onDoubleClick: (n) => {
	                    this.props.onOpenTab({
	                        key: n.item.id + "doc",
	                        title: n.item.name,
	                        content: () => (React.createElement("div", null, "not implemented yet"))
	                    });
	                }, onClick: (n) => {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	const TabReducers_1 = __webpack_require__(43);
	const redux_1 = __webpack_require__(29);
	exports.default = redux_1.combineReducers({
	    tabbar: TabReducers_1.default
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	const immutable_1 = __webpack_require__(28);
	exports.initialState = {
	    activeTab: 0,
	    tabs: immutable_1.List()
	};
	function TabReducer(state = exports.initialState.tabs, action) {
	    switch (action.type) {
	        case "ADD_TAB":
	            return state.push({
	                id: action.id,
	...
	function ActiveTabReducer(state = exports.initialState.activeTab, action) {
	    switch (action.type) {
	        case "SWITCH_TAB":
	            return action.id;
	        default:
	...
	function tabbar(state = exports.initialState, action) {
	    return {
	...
	//# sourceMappingURL=TabReducers.js.map
	        ...
	        React.createElement(semantic_ui_react_1.Segment, { className: "toolbar", inverted: true },
	            React.createElement(semantic_ui_react_1.Menu, { inverted: true, icon: "labeled", size: "massive" },
	                React.createElement(semantic_ui_react_1.Menu.Item, { name: 'properties', active: false, onClick: handleItemClick },
	                    ...
	                    "Properties"),
	                React.createElement(semantic_ui_react_1.Menu.Item, { name: 'delete', position: "right", active: false, onClick: this.handleItemClick },
