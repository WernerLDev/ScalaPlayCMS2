...
/***/ (function(module, exports, __webpack_require__) {
	...
	const SideMenu_1 = __webpack_require__(6);
	const PagesPanel_1 = __webpack_require__(7);
	const AssetsPanel_1 = __webpack_require__(21);
	const Tabs = __webpack_require__(26);
	const TabActions = __webpack_require__(27);
	const Immutable = __webpack_require__(28);
	class Main extends React.Component {
	    constructor(props, context) {
	        ...
	        let initialTabbar = {
	            tabs: Immutable.List(),
	            active: {
	                key: "", title: "", content: () => (React.createElement("p", null))
	            }
	        };
	    ...
	    openTab(t) {
	        ...
	        this.setState(Object.assign({}, this.state, { tabbar: {
	                active: t,
	                tabs: newTabs
	            } }));
	    }
	                ...
	                React.createElement(SplitPane, { split: "vertical", defaultSize: 400, minSize: 100 },
	                    React.createElement("div", { className: "leftpanel" },
	                        React.createElement("div", { className: this.state.section == "pages" ? "show" : "hide" },
	                            React.createElement(PagesPanel_1.default, { onOpenTab: this.openTab.bind(this) })),
	                        React.createElement("div", { className: this.state.section == "assets" ? "show" : "hide" },
	                            React.createElement(AssetsPanel_1.default, { onOpenTab: this.openTab.bind(this) }))),
	                    React.createElement("div", null,
	                        React.createElement(Tabs.default, { active: this.state.tabbar.active, tabs: this.state.tabbar.tabs, onClose: (tab) => {
	                                ...
	                                this.setState(Object.assign({}, this.state, { tabbar: { tabs: newtabs.toList(), active: newactive } }));
	                            }, onSwitch: (t) => {
	                                this.setState(Object.assign({}, this.state, { tabbar: Object.assign({}, this.state.tabbar, { active: t }) }));
	                            } }))))));
	    }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const PageTreeLabel_1 = __webpack_require__(15);
	const semantic_ui_react_1 = __webpack_require__(13);
	const DocumentEditMode_1 = __webpack_require__(48);
	class PagesPanel extends React.Component {
	    ...
	    render() {
	        ...
	        return (React.createElement("div", null,
	            ...
	            React.createElement(TreeView_1.default, { items: this.state.treeItems, selected: this.state.selected, onDoubleClick: (n) => {
	                    this.props.onOpenTab({
	                        key: n.item.id + "doc",
	                        title: n.item.name,
	                        content: () => (React.createElement(DocumentEditMode_1.default, { document: n.item }))
	                    });
	                }, onClick: (n) => {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	const ApiBase_js_1 = __webpack_require__(11);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	const ApiError_1 = __webpack_require__(12);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getAssetContentAsText(asset) {
	    return ApiBase_js_1.default("/admin/uploads" + asset.path, "GET", null, "text/plain");
	}
	exports.getAssetContentAsText = getAssetContentAsText;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	const React = __webpack_require__(1);
	const PageTreeContextMenu_1 = __webpack_require__(16);
	const RenameMode_1 = __webpack_require__(18);
	const AddMode_1 = __webpack_require__(19);
	const draggable_1 = __webpack_require__(20);
	class PageTreeLabel extends React.Component {
	    ...
	    renderContextMenu() {
	        return (React.createElement(PageTreeContextMenu_1.default, { target: this.state.menutarget.nativeEvent, pagetypes: this.props.pagetypes, isRootNode: this.props.item.item.doctype == "home", onDismiss: this._onDismiss.bind(this), onToggleAdd: (t) => this.setState({ addingmode: true, addtype: t }), onToggleDelete: () => {
	    ...
	    renderEditForm() {
	        ...
	        return (React.createElement(RenameMode_1.default, { defaultValue: this.props.item.item.name, icon: icon, onBlur: this._onToggleEdit.bind(this), onSubmit: (newname) => {
	                this.setState({ label: newname, editmode: false }, () => {
	                    this.props.onRenamed(Object.assign({}, this.props.item.item, { name: newname }));
	                });
	            } }));
	    }
	    render() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	const React = __webpack_require__(1);
	const ContextMenu_1 = __webpack_require__(17);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const TreeView_1 = __webpack_require__(8);
	const Api = __webpack_require__(9);
	const AssetTreeLabel_1 = __webpack_require__(22);
	const semantic_ui_react_1 = __webpack_require__(13);
	const UploadModal_1 = __webpack_require__(25);
	const ViewerFactory_1 = __webpack_require__(45);
	        ...
	        return (React.createElement("div", null,
	            ...
	            React.createElement(TreeView_1.default, { items: this.state.treeItems, selected: this.state.selected, onDoubleClick: (n) => {
	                    this.props.onOpenTab({
	                        key: n.item.id + "asset",
	                        title: n.item.name,
	                        content: () => ViewerFactory_1.default(n.item)
	                    });
	                }, onRenderLabel: this.renderLabel.bind(this), onCollapse: (i, state) => {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	const React = __webpack_require__(1);
	const AssetContextMenu_1 = __webpack_require__(23);
	const RenameMode_1 = __webpack_require__(18);
	const AddMode_1 = __webpack_require__(19);
	const draggable_1 = __webpack_require__(20);
	const AssetIcons_1 = __webpack_require__(24);
	class AssetTreeLabel extends React.Component {
	    ...
	    renderEditForm() {
	        return (React.createElement(RenameMode_1.default, { defaultValue: this.props.item.item.name, icon: AssetIcons_1.getAssetIcon(this.props.item.item.mimetype), onBlur: this._onToggleEdit.bind(this), onSubmit: (newname) => {
	...
	class TabPanel extends React.Component {
	    ...
	    render() {
	        const tabContent = (t) => {
	            ...
	            return (React.createElement("div", { key: t.key, style: { display: isActive ? "block" : "none" } }, t.content()));
	        };
	        const tabLabel = (t) => {
	            return (React.createElement("p", null,
	                t.title,
	                " ",
	                React.createElement("i", { className: "fa fa-window-close", "aria-hidden": "true" })));
	        };
	        return (React.createElement("div", null,
	            React.createElement(semantic_ui_react_1.Menu, { className: "tabbar", tabular: true }, this.props.tabs.map(tab => React.createElement(semantic_ui_react_1.Menu.Item, { key: tab.key, content: tabLabel(tab), onClick: (e) => {
	                    let target = e.target;
	                ...
	                }, name: tab.title, active: tab.key == this.props.active.key }))),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function findNewActive(tab, alltabs) {
	    let i = alltabs.findIndex(x => x.key == tab.key);
	    if (alltabs.get(i + 1) != undefined)
	        return alltabs.get(i + 1);
	    else if (alltabs.get(i - 1) != undefined)
	        return alltabs.get(i - 1);
	    else
	        tab;
	}
	exports.findNewActive = findNewActive;
	//# sourceMappingURL=TabActions.js.map
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	const React = __webpack_require__(1);
	const ImageViewer_1 = __webpack_require__(46);
	const TextViewer_1 = __webpack_require__(47);
	function default_1(asset) {
	    if (asset.mimetype.startsWith("image")) {
	        return (React.createElement(ImageViewer_1.ImageViewer, { asset: asset }));
	    }
	    else if (asset.mimetype == "text/plain") {
	        return (React.createElement(TextViewer_1.default, { asset: asset }));
	    }
	    else {
	        return (React.createElement("div", null, "Invalid asset type"));
	    }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(1);
	const semantic_ui_react_1 = __webpack_require__(13);
	exports.ImageViewer = (props) => {
	    let handleItemClick = () => {
	        alert("asdfasdf");
	    };
	    return (React.createElement("div", { className: "imageviewerback" },
	        React.createElement(semantic_ui_react_1.Segment, { className: "toolbar", inverted: true },
	            React.createElement(semantic_ui_react_1.Menu, { inverted: true, icon: "labeled", size: "massive" },
	                React.createElement(semantic_ui_react_1.Menu.Item, { name: 'properties', active: false, onClick: handleItemClick },
	                    React.createElement(semantic_ui_react_1.Icon, { name: 'setting' }),
	                    "Properties"),
	                React.createElement(semantic_ui_react_1.Menu.Item, { position: "right", name: 'deletething', active: false, onClick: handleItemClick },
	                    React.createElement(semantic_ui_react_1.Icon, { name: 'trash' }),
	                    "Remove"))),
	        React.createElement("div", { className: "imageviewer" },
	            React.createElement("img", { src: "/admin/uploads" + props.asset.path }))));
	};
	...
	class TextViewer extends React.Component {
	    ...
	    render() {
	        return (React.createElement("div", { className: "imageviewerback" },
	            React.createElement(semantic_ui_react_1.Segment, { className: "toolbar", inverted: true },
	                React.createElement(semantic_ui_react_1.Menu, { inverted: true, icon: "labeled", size: "massive" },
	                    React.createElement(semantic_ui_react_1.Menu.Item, { name: 'properties', active: false, onClick: this.handleItemClick },
	                        React.createElement(semantic_ui_react_1.Icon, { name: 'setting' }),
	                        "Properties"),
	                    React.createElement(semantic_ui_react_1.Menu.Item, { position: "right", name: 'deletething', active: false, onClick: this.handleItemClick },
	                        React.createElement(semantic_ui_react_1.Icon, { name: 'trash' }),
	                        "Remove"))),
	            React.createElement("div", { className: "textcontent" }, this.state.textContent)));
	    }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(1);
	const semantic_ui_react_1 = __webpack_require__(13);
	class DocumentEditMode extends React.Component {
	    constructor(props, context) {
	        super(props, context);
	    }
	    handleItemClick() {
	    ...
	    render() {
	        return (React.createElement("div", { id: "wrapper" },
	            ...
	            React.createElement("div", { className: "iframe-wrapper" },
	                React.createElement("iframe", { className: "documentIframe", onLoad: () => this.setState({ iframeloaded: true }), ref: "docpage", src: this.props.document.path + "?editmode=editing" }))));
	    }
	}
	exports.default = DocumentEditMode;
	//# sourceMappingURL=DocumentEditMode.js.map
